            ...
            >
              <div className="quickFindMenu">
                ...
                {hasQuery && searchResult && (
                  <>
                    {(searchResult as any).results?.length ? (
                      <NotionContextProvider {...ctx} recordMap={(searchResult as any).recordMap}>
                        <div className="resultsPane">
                          {(searchResult as any).results.map(
                            (result: {
                              ...
                              <components.PageLink
                                ...
                                href={mapPageUrl(result.page.id, (searchResult as any).recordMap)}
                              >
                        ...
                        <footer className="resultsFooter">
                          <div>
                            <span className="resultsCount">{(searchResult as any).total}</span>

                            {(searchResult as any).total === 1 ? ' result' : ' results'}
                          </div>
                        </footer>
