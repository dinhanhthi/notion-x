...
const Equation = dynamic(() => import('./BlockEquation'), {
  loading: () => (
    <div className="w-1/2 mx-auto my-4 h-20 bg-slate-200 animate-pulse rounded-md flex items-center justify-center">
...
const Code = dynamic(() => import('./BlockCode'), {
  loading: () => (
    <div className="w-full h-40 my-4 bg-slate-200 animate-pulse rounded-md flex items-center justify-center">
